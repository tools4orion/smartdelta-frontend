...
function Visualizer() {
  const location = useLocation();
	...
	const {  dispatch, showUserGuide, toggleResourceSidebar } = useVisualizerController();
	...
	<DashboardNavbar /> 
      <MDBox pt={6} pb={3}>
		...
		>
		  <DialogTitle
		   sx={bgStyles}
		  >{"Do you want to restart the visualizer tour guide?"}</DialogTitle>
		  <DialogContent
		  		  sx={ bgStyles }
		  >
			<DialogContentText id="alert-dialog-slide-description">
			Explore our visualizer feature for a better understanding and control of your microservices
			</DialogContentText>
		  </DialogContent>
