...
const deleteFile = async (dispatch, id) => {
  try {
    const response = await attachmentEndpoints.delete(id)
    console.log(response)

    // Dispatch action to update state with the deleted file ID
    console.log(`file actions ${id}`)
